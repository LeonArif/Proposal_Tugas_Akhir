...
\begin{figure}[t]
  ...
  \caption{Contoh peletakan gambar dengan judul yang panjang sehingga ditulis dalam beberapa baris dengan menggunakan gambar yang sama dengan Gambar~\ref{fig:jaringan} dengan hanya memodifikasi ukuran gambarnya saja} 
	\label{fig:jaringan2} 
